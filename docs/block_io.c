...
Block devices are organized into fixed-size blocks, typically 512 bytes or larger. The block I/O subsystem relies on device drivers to communicate with specific hardware. Requests for reading or writing data are queued and processed in a first-come, first-served manner.
